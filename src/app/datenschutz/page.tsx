        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-gray-50 p-8 sm:p-10 rounded-2xl shadow-sm border border-gray-100 space-y-8 leading-relaxed text-[15px] sm:text-[16px] font-light">
            ...
            <section>
              ...
              <p>
                Findbetter.ch (in Zusammenarbeit mit einem FINMA Registrierten Broker, E-Mail: <a href="mailto:datenschutz@findbetter.ch" className="text-blue-600 hover:underline">datenschutz@findbetter.ch</a>). Für Art. 45 VAG-Informationen siehe Offenlegungen der Partner.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>Vergleichsphase: Postleitzahl, Geburtsjahr, aktuelle Franchise, Unfalldeckungswunsch, aktuelle Grundversicherung, Ärzte-Modell.</li>
                <li>Abschlussphase (Pop-up): Anrede, Vor-/Nachname, Geburtsdatum, Telefonnummer, E-Mail, Wohnadresse, aktuelle Krankenversicherung, Policennummer, gewünschter Versicherungsbeginn, Staatsangehörigkeit.</li>
                <li>Sensible Daten: AHV-Nummer, Ausweiskopie (biometrische Daten), indirekte Gesundheitsdaten (z. B. aus Versicherungsdetails).</li>
                <li>Technische Daten: IP-Adresse, Browser-Informationen, Cookies.</li>
              </ul>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>Vertragserfüllung (Art. 31 nDSG): Für Vergleich, Abschluss, Kündigung.</li>
                <li>Einwilligung (Art. 31 nDSG, für sensible Daten): Durch Akzeptanz (z. B. AGB, Brokermandat, Vollmacht) und Signatur. Widerruf möglich.</li>
                <li>Gesetzliche Pflicht (Art. 31 nDSG): Z. B. FINMA-Registrierung, AML-Prüfungen.</li>
                <li>Berechtigtes Interesse (Art. 31 nDSG): Sicherheit, Betrugsprävention.</li>
              </ul>
            ...
            <section>
              ...
              <p>Keine Weitergabe sensibler Daten ohne Einwilligung. Übermittlungen ins Ausland (z. B. EU) mit angemessenem Schutzniveau (z. B. Standardvertragsklauseln).</p>
            </section>
            ...
            <section>
              ...
              <p>Anfragen an <a href="mailto:datenschutz@findbetter.ch" className="text-blue-600 hover:underline">datenschutz@findbetter.ch</a> mit Identitätsnachweis. Beschwerden an EDÖB.</p>
            </section>
            ...
            <section>
              ...
              <p>Fragen: <a href="mailto:datenschutz@findbetter.ch" className="text-blue-600 hover:underline">datenschutz@findbetter.ch</a></p>
            </section>
          </div>
        </div>
      </main>
